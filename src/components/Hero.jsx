...
const Hero = () => {
	return (
		...
		>
			<div className="customShape bg-sky-300/20 backdrop-blur-md h-full w-full">
				<div className="flex justify-center items-center h-full w-full m-7 rounded-2xl border-e-2 border-white/30">
